 ...
 * @since 0.1.0
 */
class AN_Widget_Most_Viewed extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			...
			'description' => __( 'Display top viewed posts.', 'unique' )
		);
		...
		/* Create the widget. */
		$this->WP_Widget( 'most-viewed', __( 'Most Viewed', 'unique' ), $widget_options, $control_options );
	}
